...
from pons.net.plans import ContactPlan
...
contacts = read_ccp("3n.ccp", symmetric=True, mapping=mapping)
...
netsim = pons.NetSim(SIM_TIME, nodes, config=config, realtime=True, factor=1)
